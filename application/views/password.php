                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="password" class="form-control input-transparent" id="password-field" placeholder="Type Password..">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label" for="password-field">New Password:</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                                            <input type="password" class="form-control input-transparent" id="password-field" placeholder="Type New Password..">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label" for="password-field">Re-Type New Password:</label>
                                                    <div class="col-sm-7">
                                                        <div class="input-group">
                                                            <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                                            <input type="password" class="form-control input-transparent" id="password-field" placeholder="Re-Type New Password..">
                                                        </div>
                                                    </div>
                                                </div>
                                            </fieldset>
